...
3. **🪄多样的移动模式**除了普通的单个拖拽外，堆叠世界还提供了多选、快速插入、快速吸收、传送门四种增加便捷性的移动模式（详细操作说明请见系统内的“帮助”页面）。`<img src="/i18n/img/README_multi_quick.png" alt="多选快移展示" style="max-height: 200px; width: auto;">`
